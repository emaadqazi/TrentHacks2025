...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
        ...
        <div className="w-full max-w-md">
          ...
          <Card className="border-2">
            <CardHeader className="space-y-1">
              ...
              <CardDescription>
                {isSignUp ? "Sign up to start building your resume" : "Enter your credentials to access your account"}
              </CardDescription>
            </CardHeader>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary/20 via-secondary/20 to-chart-3/20 items-center justify-center p-8">
        <div className="max-w-md text-center space-y-6">
          <div className="flex justify-center gap-4">
            <div className="h-24 w-24 rounded-2xl bg-primary/30 backdrop-blur-sm animate-[fadeInUp_0.6s_ease-out]" />
            <div className="h-24 w-24 rounded-2xl bg-secondary/30 backdrop-blur-sm animate-[fadeInUp_0.6s_ease-out_0.1s_both]" />
          </div>
          <div className="flex justify-center gap-4">
